...
class ashuwp_framework_core {
  ...
  public function enqueue_css_js() {
    wp_enqueue_media();
    wp_enqueue_style('ashuwp_framework_css', get_template_directory_uri(). '/style/framework.css');
    wp_enqueue_style( 'wp-color-picker' );
    wp_enqueue_script( 'wp-color-picker' );
    wp_enqueue_script('ashuwp_framework_js', get_template_directory_uri(). '/script/framework.js','','',true);
