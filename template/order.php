                    ...
                    <div id="pay">
                        <div class="part-order">
                            ...
                            <ul>
                                ...
                                <li><label for="receive_name"><?php _e('收货姓名：','um'); ?></label><input id="receive_name" name="order_receive_name" value="<?php echo isset($autofill['user_name'])?$autofill['user_name']:''; ?>" onkeydown="if(event.keyCode==13)return false;"></li>
                                ...
                                <li><label for="receive_email"><?php _e('用户邮箱：','um'); ?></label><input id="receive_email" name="order_receive_email" value="<?php echo isset($autofill['user_email'])?$autofill['user_email']:''; ?>" onkeydown="if(event.keyCode==13)return false;"></li>
