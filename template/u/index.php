                ...
                <div class="briefly">
					<ul>
						...
						<li class="credit">
						  ...
						  <div class="number"><?php echo $credit; ?><span>我的积分</span></div>
						  <div class="more"><a href="<?php echo um_get_user_url('credit',$curauth->ID); ?>">查看更多<i class="fa fa-arrow-circle-right"></i></a></div>
						</li>
						<li class="comments">
