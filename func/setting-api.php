...
function um_auth_field_callback(){
	?>
	<p><?php echo base64_decode('5bey5r+A5rS777yM5Y+v5L2/55So5YWo6YOo5Yqf6IO9'); ?><hr /><?php echo base64_decode('5pys5Li76aKY55SxWGlhb+S8n+egtOino+aOiOadgyE='); ?><hr /><?php echo base64_decode('WGlhb+S8n+WNmuWuoiA8YSBocmVmPSJodHRwOi8vd3d3LmhmYW5zaHUuY29tLyIgdGFyZ2V0PSJfYmxhbmsiPld3dy5IZmFuc2h1LkNvbTwvYT4='); ?></a><hr /><?php echo base64_decode('UVHnvqTkuqTmtYHvvJoxMTkzMTU4Oe+8gQ==
'); ?><hr /><?php echo base64_decode('5o+S5Lu26LSt5Lmw5Zyw5Z2A77yaPGEgaHJlZj0iaHR0cDovL3d3dy5oZmFuc2h1LmNvbS82MTguaHRtbCIgdGFyZ2V0PSJfYmxhbmsiPmh0dHA6Ly93d3cuaGZhbnNodS5jb20vNjE4Lmh0bWw'); ?></a><hr /><?php echo base64_decode('5pys56uZ5Ye65ZSu55qE5Li76aKY77yM6YO95piv5peg5o6I5p2D6ZmQ5Yi254mI77yB'); ?></p>
	<?php
}
